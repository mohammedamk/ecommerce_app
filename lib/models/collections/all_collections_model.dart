class AllCollectionsModel {
  ...
  AllCollectionsModel.fromJson(dynamic json) {
    ...
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(AllCollectionsData.fromJson(v));
      });
    }
  }
  String? _status;
  List<AllCollectionsData>? _data;

  String? get status => _status;
  List<AllCollectionsData>? get data => _data;
...
class AllCollectionsData {
  AllCollectionsData({
      ...
      String? description, 
      num? productsCount, 
      List<AllCollectionsProducts>? products,
      String? createdAt, 
      String? updatedAt, 
      num? v,}){
    _id = id;
  ...
  AllCollectionsData.fromJson(dynamic json) {
    _id = json['_id'];
    ...
    if (json['products'] != null) {
      ...
      json['products'].forEach((v) {
        _products?.add(AllCollectionsProducts.fromJson(v));
      });
    }
  ...
  String? _description;
  num? _productsCount;
  List<AllCollectionsProducts>? _products;
  String? _createdAt;
  String? _updatedAt;
  num? _v;
  ...
  List<AllCollectionsProducts>? get products => _products;
...
class AllCollectionsProducts {
  ...
  AllCollectionsProducts.fromJson(dynamic json) {
    _id = json['_id'];
