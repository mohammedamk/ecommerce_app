...
import '../admin/orders/widget/order_widget.dart';

class OrdersDetailsScreen extends StatefulWidget {
  final OrderData model;
  const OrdersDetailsScreen({super.key, required this.model});
      ...
      body: SingleChildScrollView(
        child: SafeArea(
          child: Column(
            ...
            children: [
              commonAppBar(text: "View Order Details", isBack: true,bottomSpace: 16,topSpace: 0),
              textWidget(text: "Order Details",fontWeight: FontWeight.bold,fontSize: 20).paddingOnly(top: 16),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        textWidget(text: DateFormat('dd MMM, yyyy').format(DateTime.parse((model.createdAt.toString()))),fontWeight: FontWeight.bold,fontSize: 16),
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      ...
                      children: [
                        ...
                        textWidget(text: "${model.orderId}",fontWeight: FontWeight.bold,fontSize: 16),
                      ],
                    ...
                    Row(
                      ...
                      children: [
                        textWidget(text: "Order total",fontWeight: FontWeight.bold,fontSize: 16),
                        textWidget(text: "\$${model.totalAmount} (${model.totalItems} items)",fontWeight: FontWeight.bold,fontSize: 16),
                    ...
                    InkWell(
                      ...
                      child: Row(
                        ...
                        children: [
                          textWidget(text: "Order Status",fontWeight: FontWeight.bold,fontSize: 16,color: primary),
                          textWidget(text: model.orderStatus.toString(),fontWeight: FontWeight.bold,fontSize: 16,color: primary),
              ...
              textWidget(text: "Shipping Details",fontWeight: FontWeight.bold,fontSize: 20),
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListView.builder(
                      itemCount: model.orderedProducts!.length,
                      shrinkWrap: true,
              ...
              textWidget(text: "Payment Information",fontWeight: FontWeight.bold,fontSize: 20),
              Container(width: double.infinity,
                decoration: BoxDecoration(
                  color: white,
                  border: Border.all(
              ...
              textWidget(text: "Shipping Address",fontWeight: FontWeight.bold,fontSize: 20),
              Container(width: double.infinity,
                decoration: BoxDecoration(
                  color: white,
                  border: Border.all(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    textWidget(text: "Harsh Shambhuwani",),
                    textWidget(text: shippingAddress),
                  ],
                ).paddingAll(16),
              ).paddingSymmetric(vertical: 16),

              textWidget(text: "Order Summary",fontWeight: FontWeight.bold,fontSize: 20),
              Container(width: double.infinity,
                decoration: BoxDecoration(
                  color: white,
                  border: Border.all(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Divider(),
                    textWidget(text: "Your Savings: \$10",
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      color: primary,
                      fontSize: 16,
