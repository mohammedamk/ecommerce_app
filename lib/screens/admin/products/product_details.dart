...
// import 'package:vweb_ecommerce/constants/colors.dart';
        ...
        body: backgroundContainer(
          child: SingleChildScrollView(
            child: SafeArea(
              ...
              children: [
                commonAppBarTwo(text: "Products Details",topSpace: 0,bottomSpace: 0),
                Row(
                  children: [
                    ClipRRect(
                    ...
                    Row(
                      children: [
                        ...
                        InkWell(
                            onTap: () {},
                            child:
                                const Icon(Icons.share_outlined).paddingAll(3)),
                      ],
                    )
                  ],
                ...
                textWidget(
                        text:
                            "Shipping Information: ${model.shippingInformation}")
                    .paddingSymmetric(horizontal: 20, vertical: 6),
                const Divider(),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    returnPolicyWarranty(widget: model.returnPolicy.toString() == "No return policy"
                        ? Image.asset(
                    ...
                    returnPolicyWarranty(widget: model.warranty.toString() ==
                    "No warranty"
                    ? Image.asset(
